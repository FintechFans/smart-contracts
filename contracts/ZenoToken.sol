 ...
 */
contract ZenoToken is HumanERC20TokenInterface {
     ...
     */
    function ZenoToken(string name, string symbol, uint8 decimals, uint256 totalStartingSupply)
        HumanERC20TokenInterface(name, symbol, decimals)
    {
